...
service BPMN workflow. That means it is links to ONAP source code
and lifecycle.

**Alacarte** method required the Operator people to build and send
a lot of operations. To build those requests, Operator guy needs to
define/collect by himself all VNF parameters/values.

**Macro** method required the Operator to build and send only one request and,
