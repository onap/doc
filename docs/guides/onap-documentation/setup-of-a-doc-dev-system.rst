...
.. list-table::
    ...
    * - Esbonio › Sphinx: Build Dir
      - The directory in which to store Sphinx's build output
    * - Esbonio › Sphinx: Conf Dir
      - The directory containing your project's 'conf.py' file
    * - Esbonio › Sphinx: Src Dir
      - The directory containing your rst source files
    * - Restructuredtext: Styles
      - Local paths to CSS style sheets to use from the restructuredtext preview
