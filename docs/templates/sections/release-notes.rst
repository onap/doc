...
.. note::
   ...
   * Except the section "Release data" all other sections are optional and should be applied where
     applicable
...
List of new security issues that are left unfixed in this release including CVEs and
OJSI tickets.
