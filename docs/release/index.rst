...
Summary
+++++++
NAP provides a comprehensive platform for real-time, policy-driven
...
controlled domain:
 ...
 - Virtual Function Controller (VF-C) is responsible for lifecycle management of virtual network functions
   and newtork services based on VNF using VNF Manager.
...
Detect -> Publish -> Respond:
 ...
 - Holmes provides alarm correlation and analysis for Telecom cloud
   infrastructure and services, including servers, cloud infrastucture,
