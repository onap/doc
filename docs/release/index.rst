...
- Cloud Native Function (CNF) support with better integration with k8s to get
  k8s resources status deployed and to provide day2 configuration
- Extended end-to-end 5G network slicing
- Intent-Based networking introduction
- Control loop evolutions with CLAMP functionality merged into Policy Framework
  project and new capabilities to define control loops using TOSCA
- Fault management with DCAE optimization
