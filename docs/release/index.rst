...
.. _elaltorelease-notes:

ElAlto Release Notes
^^^^^^^^^^^^^^^^^^^^^

This page provides the release notes for the ONAP ElAlto release. This includes details of software versions used, known limitations, and
outstanding trouble reports.

Release notes are cumulative for the release, meaning this release note for the ElAlto release will have an entry for each Major, Minor, and Maintenance
...
The ElAlto 5.0.0 is the first release for ElAlto.
...
Documentation
=============
ONAP ElAlto Release provides multiple documents, see :ref:`ONAP Home<master_index>`.
...
===========================
For ElAlto release, ONAP continues to improve in multiple areas of Scalability, Security, Stability and Performance (S3P) metrics.
