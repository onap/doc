...
# enable later and remove duplicated entry at 'latest' # intersphinx_mapping['onap-cli'] = ('{}/onap-cli/en/%s'.format(doc_url) % branch, None)
...
# enable later and remove duplicated entry at 'honolulu' # intersphinx_mapping['onap-dmaap-dbcapi'] = ('{}/onap-dmaap-dbcapi/en/%s'.format(doc_url) % branch, None)
...
# enable later and remove duplicated entry at 'honolulu' # intersphinx_mapping['onap-modeling-modelspec'] = ('{}/onap-modeling-modelspec/en/%s'.format(doc_url) % branch, None)
...
# enable later and remove duplicated entry at 'honolulu' # intersphinx_mapping['onap-vnfsdk-model'] = ('{}/onap-vnfsdk-model/en/%s'.format(doc_url) % branch, None)
...
linkcheck_ignore = [
    ...
    # anchor issues
    'https://docs.onap.org/projects/onap-integration/en/istanbul/docs_usecases_release.html#.*',
    'https://docs.linuxfoundation.org/docs/communitybridge/easycla/contributors/contribute-to-a-gerrit-project#.*',
    'https://docs.onap.org/projects/onap-integration/en/istanbul/docs_robot.html#docs-robot',
    'https://docs.onap.org/projects/onap-integration/en/istanbul/docs_usecases_release.html#docs-usecases-release',
    'https://docs.onap.org/projects/onap-integration/en/istanbul/docs_usecases.html#docs-usecases',
    'https://docs.onap.org/projects/onap-integration/en/istanbul/usecases/release_non_functional_requirements.html#release-non-functional-requirements',
]
