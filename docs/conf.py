...
# ********************************* IMPORTANT *********************************
# Beginning with the 'Jakarta' release a project/repository contributing
# to the documentation of the release needs to ...
# - be actively maintained
# - create a branch for the new release
# We do not map to documentation of repositories anymore that have not
# created a branch for the new release and that are no longer maintained.
# ********************************* IMPORTANT *********************************

#
# Map to 'latest' if this conf.py is used in the 'latest' (master) dev branch.
# Map to '{releasename}' if this conf.py is used in the release branch.
#
branch = 'latest'
