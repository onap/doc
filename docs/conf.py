...
linkcheck_ignore = [
    ...
    # anchor issues
    'https://docs.onap.org/projects/onap-integration/en/jakarta/docs_usecases_release.html#.*',
    'https://docs.linuxfoundation.org/docs/communitybridge/easycla/contributors/contribute-to-a-gerrit-project#.*',
    'https://docs.onap.org/projects/onap-integration/en/jakarta/docs_robot.html#docs-robot',
    'https://docs.onap.org/projects/onap-integration/en/jakarta/docs_usecases_release.html#docs-usecases-release',
    'https://docs.onap.org/projects/onap-integration/en/jakarta/docs_usecases.html#docs-usecases',
    'https://docs.onap.org/projects/onap-integration/en/jakarta/usecases/release_non_functional_requirements.html#release-non-functional-requirements',
]
